// Файл catalog-query-server/internal/infrastructure/observability/metrics.go содержит реализацию пакета observability.
...
// MetricsCollector holds all Prometheus metrics for catalog-query-server
