...
import (
	...
	"github.com/rusgainew/kkm-project-mks/foreign-company-query-server/internal/infrastructure/migration"
...
func main() {
	...
	// Create repository
	repo := repository.NewPostgresForeignCompanyRepository(db, logger)
...
func healthCheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprint(w, `{"status":"ok","service":"foreign-company-query-server"}`)
}
