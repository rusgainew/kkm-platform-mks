// Файл foreign-company-query-server/internal/infrastructure/observability/metrics.go содержит реализацию пакета observability.
...
// MetricsCollector holds all Prometheus metrics for bank-account-query-server
