...
import (
	...
	"github.com/rusgainew/kkm-project-mks/bank-account-query-server/internal/infrastructure/migration"
...
func main() {
	...
	// Create repository
	repo := repository.NewPostgresBankAccountRepository(db, logger)
...
func healthCheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprint(w, `{"status":"ok","service":"bank-account-query-server"}`)
}
