...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.PieChartData"
                        }
                    },
                    "500": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.SalesChartData"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/api/analytics/stats": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Time period: today, week, month, quarter, year, custom",
                        "name": "period",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.DashboardStats"
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "type": "integer",
                        "default": 10,
                        "description": "Number of contractors to return",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/http.TopContractor"
                            }
                        }
                    },
                    "500": {
        ...
        "/companies/{id}/members/{memberId}": {
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Member/Employee ID",
                        "name": "memberId",
                        "in": "path",
                        "required": true
                    }
        ...
        "/documents-query/pending-approval": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/foreign-companies-query/filter": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/foreign-companies-query/search": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/models.InvoiceDetail"
                                            }
                                        }
                                    }
                                }
    ...
    "definitions": {
        ...
        "http.PieChartData": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.PieChartDataPoint"
                    }
                }
            }
        },
        "http.PieChartDataPoint": {
            "type": "object",
            "properties": {
                "color": {
                    "type": "string"
        ...
        "http.SalesChartData": {
            ...
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/http.ChartDataPoint"
                    }
                },
                "period": {
                    "$ref": "#/definitions/http.Period"
        ...
        "models.Catalog": {
            ...
            "properties": {
                "category": {
                    "description": "Категория (deprecated, использовать TnvedCode)",
                    "type": "string"
                },
                "created_at": {
                    "type": "integer"
