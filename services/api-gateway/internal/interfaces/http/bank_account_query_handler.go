...
func (h *BankAccountQueryHandler) ListBankAccounts(c *gin.Context) {
	...
	resp, err := h.service.ListBankAccounts(c.Request.Context(), conversion.SafeInt64ToInt32WithDefault(page, 0), conversion.SafeInt64ToInt32WithDefault(pageSize, 20))
	if err != nil {
