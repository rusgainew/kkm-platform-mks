...
import (
	...
	"github.com/rusgainew/kkm-project-mks/invoice-query-server/internal/infrastructure/migration"
...
func main() {
	...
	// Create repository
	repo := repository.NewPostgresInvoiceRepository(db, logger)
...
func healthCheckHandler(w http.ResponseWriter, r *http.Request) {
	...
	fmt.Fprint(w, `{"status":"ok","service":"invoice-query-server"}`)
}
